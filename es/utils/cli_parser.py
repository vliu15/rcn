...
def arg_parser():
    ...
    parser.add_argument('--num_timesteps', help='number of timesteps to train for', nargs='?', type=int, default=1000000)
    ...
    parser.add_argument('--num_threads', nargs='?', type=int, default=4)
